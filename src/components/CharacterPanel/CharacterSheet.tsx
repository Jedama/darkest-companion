...
const ASSETS = {
  ...
  paths: {
    ...
    bookmarks: {
      health: (level = 10) => 
        new URL(`${BASE_PATH}/ui/panels/characterpanel/bookmarks/health_${level}.png`, import.meta.url).href,
      mental: (level = 10) => 
        new URL(`${BASE_PATH}/ui/panels/characterpanel/bookmarks/mental_${level}.png`, import.meta.url).href,
    }
  }
};
