...
function buildCharactersSection(involvedCharacters: Character[]): string {
  const lines: string[] = [];
...
function buildRelationshipLines(involvedCharacters: Character[]): string {
  const lines: string[] = [];
...
function buildLocationSection(estate: Estate, locations: LocationData[]): string {
...
function buildBystandersSection(
  estate: Estate,
...
function buildEnemiesSection(enemies: Enemy[]): string {
...
function buildEventSection(event: EventData, involvedCharacters: Character[], enemies: Enemy[]): string {
  let desc = replaceCharacterPlaceholders(event.description, involvedCharacters);
  desc = replaceEnemyPlaceholders(desc, enemies);
